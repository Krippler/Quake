...
//	
	...
	ent->free = false;
// sv.worldmodel points into mod_known, which is in bss; see
// PR_SetEngineString in pr_edict.c for why subtracting pr_strings from that
// does not give an offset to it.
